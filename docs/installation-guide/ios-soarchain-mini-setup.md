...
>  ​[Android Setup Guide](/docs/installation-guide/android-soarchain-mini-setup.md)
...
> App Store link to the [Soarchain Provisioning](https://apps.apple.com/tr/app/soarchain-provisioning/id6446476168) app.
...
While the Soarchain mini is plugged to your vehicle and from your phone navigate to ```Settings > Personal Hotspot ```  and enable the hotspot settings.
...
> If you still don’t see your iPhone’s name on the list please toggle back to the ```Settings > Personal Hotspot``` screen, then disable and enable the hotspot and quickly come back to the ***Soarchain Provisioning***  app again. 
...
> Disconnect and then reconnect the Soarchain Mini to your car. Close the **Soarchain Secure Provisioning** app, reopen it, and resume from the QR code scanning step.
